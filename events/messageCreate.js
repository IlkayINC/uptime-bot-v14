    ...
    execute(message, client) {
        ...
        if(db.fetch(`Bakım`)) {
          ...
          const Bakımda = new EmbedBuilder()
           ...
           .setDescription(`<:reddet:1121426474856087632> **Sizlere en iyi hizmeti vermek için kısa süreliğine bakımdayız. Daha ayrıntılı bilgi için destek sunucusuna gelebilirsiniz. Bakım sebebi: \`${db.fetch(`BakımSebep`)}\`**`)
          ...
          if(message.author.id !== "852863161605816320" && message.author.id !== "788717157919096854"){
      ...
      const Kullanamazsın = new EmbedBuilder()
           ...
           .setDescription(`<:icons_ban:1121440264054112346> **Karalistemde bulunduğun için komutlarımı kullanmazsın, karalisteye alınma sebebini öğrenmek için veya karalisteden çıkartılmak için destek sunucuma gelebilirsin.**`)
            ...
            if (timestampt.has(message.author.id)) {
                ...
                if (now < expiration) {
                    ...
                    const embeduyarı = new EmbedBuilder()
                        .setDescription(`<:reddet:1121426474856087632> Bu komutu tekrar kullanabilmek için **${timeleft} saniye** beklemelisin.`)
                        .setColor('Red')
                        .setTitle("Hata")
        ...
        if (cmd.yetki) {
            ...
            var yetkiyok = new EmbedBuilder()
                .setDescription(`<:reddet:1121426474856087632> Bu komutu kullanabilmek için **${yetki}** yetkisine sahip olmalısın.`)
                .setColor('Red')
                .setTitle("Hata")
        ...
        if (cmd.botyetki) {
            ...
            var botyetkiyok = new EmbedBuilder()
                .setDescription(`<:reddet:1121426474856087632> Bu komutu kullanabilmek için **${botyetki}** yetkisine sahip olmalıyım.`)
                .setColor('Red')
                .setTitle("Hata")
